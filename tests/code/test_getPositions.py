...
def test_getActivePositions():
    ...
    with mainDB.atomic() as transaction:
        dept1 = Department.create(departmentID=102, DEPT_NAME="Computer Science", ACCOUNT="6740", ORG="2114", departmentCompliance=True, isActive=True)
        dept2 = Department.create(departmentID=103, DEPT_NAME="Mathematics", ACCOUNT="6741", ORG="2115", departmentCompliance=True, isActive=True)
...
def test_getPosition():
    ...
    with mainDB.atomic() as transaction:
        ...
        assert retrieved_position.revisionDate.isoformat() == "2025-01-01"
