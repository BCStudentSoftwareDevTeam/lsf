...
/*
 POSTs the compliance status change for the department.
 Updates UI with correct button and feedback to user.
 PARAMS:
...
*/
  $.ajax({method: "POST",
      ...
      if (response["Success"]) {
        category = "info"
        let departmentID = $("#dept_btn_" + department);
        ...
        // #FIXME the table doesn't sort correctly after the ajax response.
      }
    }
  })
};
