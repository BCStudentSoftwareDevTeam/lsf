...
emailtemps= [
                ...
                "body":'''<p>Dear <strong>@@Student@@</strong>,</p>
                          ...
                          <p>Your approval or denial is required to process this contract. After @@StudentConfirmationExpiration@@ the contract will be considered denied and your supervisor will need to submit a new contract, if the position is still available.</p>
